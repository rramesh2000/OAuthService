...
namespace NUnitTestApplication
{
    public class NUnitTestTokenService
    {
        ...
        public void TestVerifyToken()
        {
            ...
            TokenValidationService tv = new TokenValidationService(new RefreshToken(), configuration, log, new JWTToken(log, new EncryptionService(), configuration), context, new EncryptionService());
